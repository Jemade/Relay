...
from backend.app.routers import threads_router, grading_router, health_router
...
app = FastAPI(
    ...
    description="RELAY Real Time AI Engine with LangGraph Multi-Agent Grading Pipeline",
    lifespan=lifespan
)
